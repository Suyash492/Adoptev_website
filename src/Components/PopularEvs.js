    ...
    <>
      ...
      <div className='mr-[5%] ml-[5%]'>
        <div className='space-y-4 mb-6'>
          <h1 className='text-xl md:text-2xl font-extrabold'> Popular EV'S</h1>
          <h3 className='text-xs md:text-base font-semibold'> With over 1 thousand + electric vehicles available on the adoptev</h3>
        </div>
...
{/* OUR SERVICES */}
        ...
        <div className='flex text-center  md:justify-evenly   overflow-x-auto  snap-x snap-mandatory'>
          <div className=' hover:bg-white hover:shadow-lg hover:shadow-black p-2  snap-center '>
            <TbMotorbike className='text-6xl mx-5 md:mx-auto shadow-md shadow-black p-2 rounded-full  hover:bg-[#02353c] hover:text-white'></TbMotorbike>
            <p className='text-sm mt-4'>Find all EV <br className='md:hidden'/> at one place</p>
          </div>

          <div className='hover:bg-white hover:shadow-lg hover:shadow-black p-2  snap-center  '>
            <MdOutlineElectricBike className='text-6xl mx-5 md:mx-auto shadow-md shadow-black p-2 rounded-full  hover:bg-[#02353c] hover:text-white'></MdOutlineElectricBike>
            <p className='text-sm mt-4'>Best deal on EV at one place</p>
          </div>

          <div className='hover:bg-white hover:shadow-lg hover:shadow-black p-2   snap-center '>
            <FaCarBattery className='text-6xl mx-8 md:mx-auto shadow-md shadow-black p-2 rounded-full  hover:bg-[#02353c] hover:text-white'></FaCarBattery>
          ...
          <div className='hover:bg-white hover:shadow-lg hover:shadow-black p-2 w-48 snap-center  '>
            <SiHandshake className='text-6xl mx-5 md:mx-auto shadow-md shadow-black p-2 rounded-full  hover:bg-[#02353c] hover:text-white'></SiHandshake>
...
{/* Buy Ev */}
        <div className=' mt-10 mb-10 md:flex  '>
          <div className='  md:grid-rows-1 md:w-1/2'>
              <p className='font-bold text-[#449342]'>Buy EV</p>
              <h1 className='text-2xl md:text-3xl font-bold'>Buying EV is now made easier</h1>
              <p className='mt-4 md:text-xl'>Buy EV from leading dealers and brand all across INDIA. It's now easy to buy latest EV and get best deal from  brand dealers. We make it easy to buy EV apply filters on range, charging time and more. You can avail subsidy upto ₹50k and more on electric scooters, bikes, 3-wheelers,cars and other transport options. </p>
          ...
          <div className='md:grid-rows-1 md:w-1/2  '>
            <img src={image49} alt=" " className=' md:mx-10 md:h-[100%] md:w-[90%]  '/>
          </div>
        </div>
